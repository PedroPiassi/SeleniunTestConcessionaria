...
class MainTest {
    ...
    class TestOfListPage {
        ...
        class FormInputs {
            ...
            @Test
            @DisplayName("Should verify that input status is correctly fill")
            void shouldVerifyThatInputStatusIsCorrectlyFill() {
            ...
            @Test
            @DisplayName("Should verify that input warranty is correctly fill")
            void shouldVerifyThatInputWarrantyIsCorrectlyFill() {
